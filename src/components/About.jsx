        ...
        <div className="bg-white/60 rounded-2xl p-8 md:p-12 ring-1 ring-inset ring-stone-200">
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <p className="text-stone-600 leading-relaxed">
              I&apos;m a Software Development Engineer based in Suwanee, GA with
              3+ years of professional experience at CodeMettle, where I&apos;ve
              grown from Junior Engineer to SDE II. I hold a B.S. in Computer
              Science from Georgia State University (2022).
            </p>
            <p className="text-stone-500 leading-relaxed">
              My work spans React dashboards, Python automation scripts, Java
              CLI tools, and CI/CD pipelines. I care about measurable outcomes
              like lower downtime, faster delivery, and software that keeps
