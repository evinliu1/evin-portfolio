const socialLinks = [
  {
    href: "https://github.com/evinliu1",
    label: "GitHub",
    icon: (
  ...
  {
    href: "https://www.linkedin.com/in/evin-liu/",
    label: "LinkedIn",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Contact = () => {
  return (
    <section className="section pb-20 lg:pb-32" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">

        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col lg:justify-center lg:pr-16">
          ...
          {/* Social links — visible on mobile/tablet where sidebar is hidden */}
